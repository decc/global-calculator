...
function updateBasicPhysics () {
  ...
  document.getElementById("slr-total-2100").innerHTML 	 = "<font color='orange'>" + 
     ( ds["climate_change"]["slr_due_to_ice_melt_2100"] + ds["climate_change"]["slr_due_to_thermal_expansion_2100"]) + " m" + "</font>";
...
*/
    ...
    jg.setColor("#636363");
    jg.setFont("arial,helvetica,sans-serif", "10px", Font.BOLD);
    jg.drawString('from pre-industrial', 	   20, 159-yOffset);
...
*/
      ...
      // update resource estimate source info 
      // -----------------------------------------------------------------
      document.getElementById('uranium_study_1b').innerHTML = "Estimate based on<br>method 1 (NucInfo)";
      document.getElementById('uranium_study_2b').innerHTML = "Estimate based on<br>method 2 (NucEnviro)";
      document.getElementById('uranium_study_3b').innerHTML = "Estimate based on<br>method 3 (NucEnviro)";

      document.getElementById('uranium_study_1a').innerHTML = "Estimate based on<br>method 1 (NucEnviro)";

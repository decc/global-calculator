...
function handleOverview2ndLevelNavigation (activeId) {
  ...
  if (activeId==1) {
    ...
    document.getElementById("container_dashboard_energy_supply").setAttribute("style", "width: 190px; height: 310px");
    document.getElementById("container_dashboard_energy_demand").setAttribute("style", "width: 145px; height: 310px");

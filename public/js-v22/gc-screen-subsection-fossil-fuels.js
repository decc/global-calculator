...
function handleFossilFuelSubnavigation (activeId) {
  ...
  if (activeId==1 || activeId==2 || activeId==3) {
    ...
    document.getElementById("ff-info-txt").innerHTML = "<br><br><br><br><br><br><hr color=\"gray\" noshade=\"\" size=\"1\">Reserves are economically viable to extract; resources are more speculative, and not economically viable to extract.";

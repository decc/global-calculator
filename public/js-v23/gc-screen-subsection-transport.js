...
function handleTransportSubnavigation (activeId) {
  ...
  // -------------------------------------------------------------
    ...
    tableNode1.setAttribute("id", "tc-diagram-table");

    var rowNode  = document.createElement("tr");
    var cellNode = document.createElement("td");
    cellNode.setAttribute("colspan", "2");
    cellNode.setAttribute("align", "center");
    cellNode.appendChild(document.createTextNode(translate ("All transport energy demand")));
    ...
    cellNode.appendChild(document.createTextNode(translate ("Number of vehicles (1000s) - Passenger")));
    rowNode.appendChild(cellNode);
    ...
    cellNode.setAttribute("colspan", "5");
    cellNode.setAttribute("align", "center");
    cellNode.appendChild(document.createTextNode(translate ("Number of vehicles (1000s) - Freight")));
    cellNode.setAttribute("style", "white-space: nowrap");
    rowNode.appendChild(cellNode);
    tableNode.appendChild(rowNode);
  ...
  // -------------------------------------------------------------
    ...
    document.getElementById("fbl-info-txt").innerHTML = translate("This graph is helpful for sanity checking whether the user's choice for 'freight distance' is compatible with the output of coal, oil and iron products generated by other lever choices.  Coal, oil and iron products account for the majority (60% in 2013) of international freight by sea.");

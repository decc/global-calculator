...
function handleElectricitySubnavigation (activeId) {
  ...
  if (activeId == 1) {
    ...
    cellNode.appendChild(document.createTextNode(translate("Installed capacity (in GW)")));
  ...
  // -------------------------------------------------------------
    ...
    document.getElementById("uranium-info-txt").innerHTML = "<br><br><br><br><br><br><hr color=\"gray\" noshade=\"\" size=\"1\" >" + translate("Reserves are economically viable to extract; resources are more speculative, and not economically viable to extract.");
